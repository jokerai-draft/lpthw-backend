...
/*
$route1 = ['method' => 'GET',  'action' => 'index', 'callback' => 'index', 'controller' => 'ArticleController'];
$route2 = ['method' => 'GET',  'action' => 'show', 'callback' => 'show', 'params' => 'id', 'controller' => 'ArticleController'];
$route3 = ['method' => 'GET',  'action' => 'edit', 'callback' => 'edit', 'params' => 'id', 'controller' => 'ArticleController'];
$route4 = ['method' => 'POST', 'action' => 'update', 'callback' => 'update', 'params' => 'id', 'controller' => 'ArticleController'];
$route5 = ['method' => 'GET',  'action' => 'create', 'callback' => 'create', 'controller' => 'ArticleController'];
$route6 = ['method' => 'POST', 'action' => 'store', 'callback' => 'store', 'controller' => 'ArticleController'];
$route7 = ['method' => 'POST', 'action' => 'destroy', 'callback' => 'destroy', 'params' => 'id', 'controller' => 'ArticleController'];
